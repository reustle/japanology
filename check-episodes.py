...
ENDPOINT = 'https://www.youtube.com/oembed?format=json&url=http://www.youtube.com/watch?v='


def pull_episode(video_id):
    """ Pull the json detials of a specific episode """
  
    path = ENDPOINT + video_id
        ...
        for season in seasons:
            for episode in season['episodes']:
                ...
                if video_details.status_code != 200:
                    print(f"{episode['title']}\t\t{episode['date']}\t\t{episode['vid']}")
